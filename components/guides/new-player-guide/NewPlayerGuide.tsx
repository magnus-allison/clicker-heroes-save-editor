...
import { GuideIndex, type GuideSectionLink } from '@/components/guides/GuideIndex';
...
const sections = [
	...
	{ id: 'ancients-before-transcending', title: 'Ancients before transcending' },
	{ id: 'ancients-after-transcending', title: 'Ancients after transcending' },
...
] as const satisfies readonly GuideSectionLink[];

export const NewPlayerGuide: FC = () => (
	<article className='flex flex-col gap-6'>
		<div className='flex flex-col gap-4'>
			<p className='max-w-3xl text-[13px] leading-6 text-(--color-fg-secondary)'>
		...
		>
			<GuideList>
				...
				<GuideListItem>Fire every skill to punch through a boss wall, roughly every half hour.</GuideListItem>
				<GuideListItem>
		...
		>
			<GuideList>
				<GuideListItem>
					Back up your save regularly to cloud storage, or just email the text file to yourself. You can pull
					a copy out at any time with the <GuideLink href='/tools/save-editor'>save editor</GuideLink>.
				</GuideListItem>
				<GuideListItem>
				...
				<GuideListItem>
					Ignore Dread Knight. His cost-to-DPS ratio is terrible; what you actually want is the ×10 bonus for
					taking a hero to level 1000, and the Power 5 will serve for a long while.
				</GuideListItem>
				<GuideListItem>
		...
		<GuideSection
			...
			title='Ancients before transcending'
		>
			<GuideList>
				<GuideListItem>
				...
				<GuideListItem>
					Hold unspent Hero Souls equal to the square of their level — level 5 ancients means keeping 25 Hero
					Souls spare.
				</GuideListItem>
			</GuideList>
		</GuideSection>
		...
		<GuideSection
			...
			title='Ancients after transcending'
		>
			<GuideList>
				<GuideListItem>
				...
				<GuideListItem>
					...
					<GuideLink href='/tools/ancients-calculator'>ancients calculator</GuideLink> — import your save and
					it returns optimal levels and costs for idle, hybrid or active.
				</GuideListItem>
			</GuideList>
		</GuideSection>
		...
		>
			<GuideList>
				...
				<GuideListItem>You give up ancients, relics, Hero Souls, zone gilds and zone progress.</GuideListItem>
				<GuideListItem>
				...
				<GuideListItem>
					...
					bosses. That is why it is not worth grinding before your first transcension: take it at zone 300 and
					earn the souls back faster afterwards.
				</GuideListItem>
				<GuideListItem>
		...
		>
			<GuideList>
				...
				<GuideListItem>Keep a small reserve for reviving mercenaries while it is still cheap.</GuideListItem>
				<GuideListItem>
				...
				<GuideListItem>
					Timelapse becomes important tens of thousands of zones in. Use it at the start of a long ascension,
					with your gilds stacked and long ruby merc quests running.
				</GuideListItem>
				<GuideListItem>
		...
		>
			<GuideList>
				...
				<GuideListItem>
					<GuideLink href='/tools/instakill-calculator'>Instakill calculator</GuideLink> — zones per hour and
					monsters per zone once Kumawakamaru and Borb start mattering.
				</GuideListItem>
				<GuideListItem>
